$(document).ready(function () {
    ...
    $(".send_message").click(function(){
        ...
        const datetime = `${dayOfWeek}, ${time}`;
            ...
            $.ajax({
                type:"POST",
                url:"http://" + window.location.host + "/Farshtore/Chat_Save/" + Other_Id + "/" + String(text_Enter) + "/" + dataCode + "/" + datetime,
    ...
    function disableButtonForOneMinute() {
        ...
        var remainingTime = 60; // Remaining time in seconds
    ...
    function Load_Chat_Messages(Code) {
        ...
        if (Res  == "Support") {
            $.ajax({
                type: "POST",
                url: "http://127.0.0.1:8000/Farshtore/Get_Id_Support/" + Code + "/" + With,
                success: function(result) {
                    if (result != "False") {
                        $("#Other_Id").text(result);
                        $.ajax({
                            type:"POST",
                            url:"http://" + window.location.host + "/Farshtore/Chat_Read/" + Code + "/" + $("#Other_Id").text(),
                            success:function(result) {
                                if (result != "False") {
            ...
            $.ajax({
                type: "POST",
                url: "http://127.0.0.1:8000/Farshtore/Get_Id/" + Code + "/" + With,
                success: function(result) {
                    if (result != "False") {
                        $("#Other_Id").text(result);
                        $.ajax({
